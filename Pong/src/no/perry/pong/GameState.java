...
/**
 * @author Perry
 * A new version of the original Pong game
 */
public class GameState extends State implements TouchListener, CollisionListener {
	...
	public void draw(Canvas canvas){
		...
		can.drawText(pl1Score==21 ? "Player 1 has won!" : "Score player 1: "+pl1Score, (canvasWidth/2)-100, (canvasHeight/2)-20, font1);
		can.drawText(pl2Score==21 ? "Player 2 has won!" : "Score player 2: "+pl2Score, (canvasWidth/2)-100, (canvasHeight/2)+20, font2);
